...
const AnalyticsCard = ({ topLabel, number, unit, bottomLabel, smallNumber, smallLabel, loaded }) => {
    const mainCount = useCountUp(number, 800, loaded);
    const smallCount = useCountUp(smallNumber, 800, loaded);
        ...
        <div className="analytics-card">
            ...
            <div className="analytics-card-lower">
                <div className="analytics-card-white">
                    <span className="analytics-card-number" style={blurStyle(mainCount.blur)}>
                        {loaded ? mainCount.value : '—'}
                    </span>
                    <span className="analytics-card-unit">{unit}</span>
                    <span className="analytics-card-divider-label">{bottomLabel}</span>
                </div>
                <div className="analytics-card-blue">
                    <span className="analytics-card-small-number" style={blurStyle(smallCount.blur)}>
                        {loaded ? smallCount.value : '—'}
                    </span>
