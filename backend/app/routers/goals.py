...
def accept_plan(goal_id: str, request: AcceptPlanRequest):
    ...
    # If the user sends "AI_DECIDE" or doesn't provide a date, we keep the date originally generated by AI
    # This prevents clearing the date (removing "Skip deadline" logic)
    if not request.due_date or request.due_date == "AI_DECIDE":
