...
PIANO_INITIAL = {
    ...
    "tasks": [
        ...
        {
            "ai_id": "task_2",
            "description": "Learn the basics & proper posture",
            "order": 2,
            "status": "not_started",
            "due_date": "2026-03-01",
            ...
            "subtasks": [
                {
                    "ai_id": "task_2a",
                    "description": "Learn the keyboard layout and notes",
                    "order": 1,
                    "status": "not_started",
                    "due_date": "2026-02-25",
                ...
                {
                    "ai_id": "task_2b",
                    "description": "Master correct sitting posture",
                    "order": 2,
                    "status": "not_started",
                    "due_date": "2026-02-27",
                ...
                {
                    "ai_id": "task_2c",
                    "description": "Learn the finger numbering system",
                    "order": 3,
                    "status": "not_started",
                    "due_date": "2026-03-01",
        ...
        },
        {
            ...
            "subtasks": [
                {
                    "ai_id": "task_3a",
                    "description": "Learn the treble clef notes",
                    "order": 1,
                    "status": "not_started",
                    "due_date": "2026-03-05",
                ...
                {
                    "ai_id": "task_3b",
                    "description": "Learn the bass clef notes",
                    "order": 2,
                    "status": "not_started",
                    "due_date": "2026-03-08",
                ...
                {
                    "ai_id": "task_3c",
                    "description": "Understanding note values and rhythm",
                    "order": 3,
                    "status": "not_started",
                    "due_date": "2026-03-10",
        ...
        },
        {
            ...
            "subtasks": [
                {
                    "ai_id": "task_4a",
                    "description": "Right & left hand C major scale",
                    "order": 1,
                    "status": "not_started",
                    "due_date": "2026-03-15",
                ...
                {
                    "ai_id": "task_4b",
                    "description": "Two-handed C major scale",
                    "order": 2,
                    "status": "not_started",
                    "due_date": "2026-03-18",
                ...
                {
                    "ai_id": "task_4c",
                    "description": "G major & F major scales",
                    "order": 3,
                    "status": "not_started",
                    "due_date": "2026-03-20",
        ...
        {
            "ai_id": "task_5",
            "description": "Learn your first full song",
            "order": 5,
            "due_date": "2026-03-31",
            "status": "not_started",
            "requires_input": False,
            ...
            "subtasks": [
                {
                    "ai_id": "task_5a",
                    "description": "Choose a beginner song",
                    "order": 1,
                    "status": "not_started",
                    "due_date": "2026-03-22",
                ...
                {
                    "ai_id": "task_5b",
                    "description": "Learn the melody (right hand)",
                    "order": 2,
                    "status": "not_started",
                    "due_date": "2026-03-25",
                ...
                {
                    "ai_id": "task_5c",
                    "description": "Add the chords (left hand)",
                    "order": 3,
                    "status": "not_started",
                    "due_date": "2026-03-28",
                ...
                {
                    "ai_id": "task_5d",
                    "description": "Play beautifully and rhythmically",
                    "order": 4,
                    "status": "not_started",
                    "due_date": "2026-03-31",
        ...
        },
        {
            ...
            "subtasks": [
                {
                    "ai_id": "task_6a",
                    "description": "Set a daily practice time",
                    "order": 1,
                    "status": "not_started",
                    "due_date": "2026-04-01",
                    "guidance": "Connect it to an existing habit (e.g., right after dinner) to make it stick."
                }
            ]
        }
    ]
